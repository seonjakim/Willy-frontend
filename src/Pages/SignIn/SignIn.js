    ...
    return (
        <SignInWrapper>
            <BoxSize>
                ...
                <KakaoBtn>
                    <Sns src="https://pilly.kr/images/icons/auth/icon-auth-kakaotalk.png" /> KAKAO 로그인
                </KakaoBtn>
                <FbBtn>
                    <Sns src="https://pilly.kr/images/icons/auth/icon-auth-facebook.png" /> FACEBOOK
                </FbBtn>
                <NaverBtn>
                    <Sns src="https://pilly.kr/images/icons/auth/icon-auth-naver.png" /> NAVER 로그인
                </NaverBtn>
            </BoxSize>
        </SignInWrapper>
    );
...
export const LoginBtn = styled(Buttons)`
    background-color: ${props => { return color.pillyColor; }};
    justify-content: center;
    margin-top: 35px;
`;
